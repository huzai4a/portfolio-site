...
const Landing = () => {
  return (
    <div className="flex items-center justify-center flex-col min-h-screen">
          <h1 className="text-5xl sm:text-7xl  font-bold text-gray-100 dark:text-white-50">
          ...
          <p className='text-sm sm:text-base text-gray-100 dark:text-gray-100 flex text-center max-w-xl px-2'>
