  ...
  return (
    ...
    <div className="flex justify-end items-center pt-5 pr-5">
        <div className="flex text-gray-50 z-10">
            <a href="mailto:huzaifa_syed78@hotmail.com" data-rb-event-key="mailto:huzaifa_syed78@hotmail.com" className="px-2 transition duration-100 hover:text-purple-100" title='email'>
                <IoMdMail size={'25px'} />
            </a>
            <a href="https://github.com/huzai4a" className="px-2 transition duration-100 hover:text-purple-100" target='_blank' title='github'>
                <FaGithub size={'25px'} />
            </a>
